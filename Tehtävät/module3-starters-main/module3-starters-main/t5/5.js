...
for(let x = 0; x < 9; x++){
    let kortti= document.createElement("article");
    kortti.classList.add("card");
    kortti.innerHTML = '<h2>'+picArray[x].title+'</h2><figure><img src="'+picArray[x].image.medium +'" alt="'+picArray[x].title+'"><figcaption>'+picArray[x].caption+'</figcaption></figure><p>'+picArray[x].description+'</p>';
    document.getElementById("pictures").appendChild(kortti);
